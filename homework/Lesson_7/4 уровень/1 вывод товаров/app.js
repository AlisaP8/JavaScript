...
/**
 * Эта функция вызывается при клике по кнопкам.
 ...
 * tablets или tv. Генерирует разметку и вставляет в .products
 * @param {string} category здесб прилетает значение атрибута data-type у кнопки,
 * по которой кликнули.
 */

function showCategory(category) {
    let div = '';
    let newCategory = products[category];
    newCategory.forEach(function (newEl) {
        div += getProductMarkup(newEl);
    })
